//! Firewall tab placeholder — Windows Firewall rule management.
//!
//! Content deferred to Phase 4 (FW-01 through FW-06).
...
/// Firewall tab placeholder component.
pub struct FirewallTabComponent;

impl Component for FirewallTabComponent {
